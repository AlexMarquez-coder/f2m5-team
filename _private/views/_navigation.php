...
<ul id="mainmenu">
    ...
    <li>
        <a href="<?php echo url( 'over_ons' ) ?>"<?php if ( current_route_is( '' ) ): ?>  class="active"<?php endif ?>>Login</a>
    </li>
    <li>
        <a href="<?php echo url( 'contact' ) ?>"<?php if ( current_route_is( '' ) ): ?>  class="active"<?php endif ?>>Over ons</a>
    </li>
    <li>
